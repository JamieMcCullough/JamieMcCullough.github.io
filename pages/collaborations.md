...
<div class="row t30">
    ...
    <div class="medium-4 columns b15">
        <img src="https://profiles.stanford.edu/proxy/api/cap/profiles/86009/resources/profilephoto/350x350.1509539055841.jpg" alt="" height=auto width=250px class="circular--square">
...
<div class="row t30">
    ...
    <div class="medium-6 columns b15">
        ...
        <p style="text-align:center"><a href="https://www.physik.lmu.de/observatory/en/research/cosmology-at-usm/acai-group/">Moritz Gammel (LMU Munich)</a><br><br>See 4C3R2 Target Selection<br>JM & Gammel <em>et al.</em> (in prep)<br></p>
    </div><!-- /.medium-6.columns -->
</div><!-- /.row -->
<div class="row t30">
    <div class="medium-6 columns b15">
