...
header:
    title: "<h5 style='color:white;font-size: 2rem;'>Intrinsic alignment demographics:</h5><h4 style='color:gray;font-size: 3rem;'>Revealing galaxy propoerty trends with DESI Y1</h4>"
